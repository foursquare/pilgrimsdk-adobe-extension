 ...
 */
- (void)pilgrimManager:(FSQPPilgrimManager *)pilgrimManager handleNearbyVenues:(NSArray<FSQPNearbyVenue *> *)nearbyVenues DEPRECATED_MSG_ATTRIBUTE("This is being deprecated for our new geofence solution. Please contact a Foursquare representative for more details.");
 ...
 */
@property (class, nonatomic, readonly) NSString *pilgrimSDKVersionString;
